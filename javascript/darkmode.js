...
const btnToggle = document.querySelector('.btn-darkmode1');
const btnToggle2 = document.querySelector('.btn-darkmode2');
...
btnToggle.addEventListener('click', () => {
    ...
    if(body.classList.contains('dark')){
        ...
        btnToggle2.innerHTML = "<i class=\"fas fa-sun\"></i>";
        ...
        btnToggle2.innerHTML = "<i class=\"fas fa-moon\"></i>";
        document.cookie = "color=dark";
